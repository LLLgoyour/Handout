...
\textbox{再谈双生子佯谬}{\index{再谈双生子佯谬}
	\begin{minipage}
		...
		如前所述，为了描述 Alice 看到的东西（考虑光到达她的眼睛），需要加上光传播时间。 
...
\textbox{与因果相关的时间顺序}{\index{因果关系}
	...
	\mtextbox{相关性}{因果关系 is a special case of correlation (conditional probability). If events E1 and E2 have nontrivial correlation, maybe
	\mtitem{
		\item E1 causes E2
		\item E2 causes E1
