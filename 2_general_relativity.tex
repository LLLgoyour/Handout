...
\textbox{在视界``内部''：未来将在奇点处消失}{
    ...
    What happened? Now $dr$ is time-like and $dt$ is space-like! The time direction and one space direction have flipped their roles. For 王二, the $-r$ direction is now the time direction.现在发生了什么？现在 $dr$ 是类时的，而 $dt$ 是类空的！时间方向和空间方向发生了翻转。对于王二来说，$-r$ 方向现在是时间方向。
